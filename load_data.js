...
function getSearchParams() {
    ...
    if (attribute_type == "year") {
        ...
        global_search['year'].push(attribute_year);
        ...
        global_search['launch'].push(attribute_launch);
        ...
        global_search['landing'].push(attribute_landing);
...
function removeFromSearch(key, value) {
    global_search[key] = global_search[key].filter(function(e) { return e != value });
...
function filterResults() {
    ...
    renderResults(serverData.filter(
        function(entry) {
            return launch_year.includes((entry.launch_year).toString());
        }
    ))
